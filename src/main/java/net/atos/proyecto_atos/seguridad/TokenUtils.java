package net.atos.proyecto_atos.seguridad;
...
public class TokenUtils {
    ...
    private final static Long ACCESS_VALIDITY_SECONDS = 2_592_000L;
    ...
    public static String createToken(String nombre, String email) {
        ...
        return Jwts.builder().setSubject(email).setExpiration(null).addClaims(extra)
